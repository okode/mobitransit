...
#import "StopCell_iPad.h"
#import "Constants.h"

@implementation StopTableViewController_iPad
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    StopCell_iPad *cell = (StopCell_iPad *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[[StopCell_iPad alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier] autorelease];
	}
